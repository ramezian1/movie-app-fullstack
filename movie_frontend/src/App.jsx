    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-blue-900 flex flex-col items-center">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-xl mt-12 p-8 flex flex-col gap-6">
        ...
        {token && (
          <div className="flex items-center justify-between gap-2">
            <div className="text-green-800 font-medium">
              Logged in! <span className="text-xs">(JWT: {token.slice(0,12)}...)</span>
            </div>
            <button
        ...
        <div className="flex items-center gap-2">
          <input
            className="border border-gray-400 rounded p-2 flex-1 focus:ring-2 focus:ring-blue-400"
        ...
        {selectedMovie && (
          <div className="border-t pt-5 mt-8">
            <div className="bg-blue-50 rounded-lg shadow p-6">
              ...
              <button
                className="mt-3 bg-blue-300 hover:bg-blue-400 px-4 py-2 rounded"
